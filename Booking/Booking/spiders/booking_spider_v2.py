...
class BookingSpider(scrapy.Spider):
    ...
    list_cur_len = 0
    count = 0
    url = "https://www.booking.com/searchresults.html?aid=397594&label=gog235jc-1FCAEoggI46AdIM1gDaBGIAQGYASG4ARfIAQzYAQHoAQH4AQyIAgGoAgO4ApiKkfYFwAIB&sid=143739acd08ffc202fc2244c06577d21&tmpl=searchresults&ac_click_type=b&ac_position=0&class_interval=1&dest_id=15&dest_type=country&from_sf=1&group_adults=2&group_children=0&label_click=undef&no_rooms=1&raw_dest_type=country&room1=A%2CA&sb_price_type=total&search_selected=1&shw_aparth=1&slp_r_match=0&src=index&src_elem=sb&srpvid=10d691d4d8f800f9&ss=Azerbaijan&ss_raw=az&ssb=empty&top_ufis=1&rows=25&offset="
    ...
    def parse_hotel_info(self, response):
        ...
        items['joined_date'] = response.css('span.hp-desc-highlighted::text').get().split("since")[1][1:-1]
